...
export const AgendaProjector: React.FC<{ config: AgendaConfig; isActive: boolean }> = ({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-between p-8 md:p-14 max-w-7xl mx-auto z-10 select-none">
      {/* Header */}
      ...
      {/* Timeline Grid */}
      <div className="w-full flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch overflow-y-auto pr-2">
          ...
          return (
            <div
              ...
              className={`relative flex flex-col justify-between p-6 rounded-2xl transition-all duration-300 cursor-pointer border ${
                isCurrent
                  ? 'bg-gradient-to-br from-purple-900/80 to-slate-900/90 border-purple-400/80 shadow-2xl shadow-purple-600/40 ring-2 ring-purple-400/50 scale-[1.02]'
