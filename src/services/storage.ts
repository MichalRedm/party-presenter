  ...
  const defaultItems = [
    {
      ...
      config: {
        ...
        items: [
          { id: 'ag_1', title: 'Wielkie Powitanie i Toast', time: '19:15', durationMinutes: 45, notes: 'Rozpoczęcie imprezy i pierwsze toasty', linkedItemId: 'item_welcome_toast' },
          { id: 'ag_2', title: 'Wielka Gra w Tajniaków', time: '20:00', durationMinutes: 60, notes: 'Drużynowe starcie kapitanów i agentów', linkedItemId: 'item_codenames_battle' },
          { id: 'ag_3', title: 'Wspomnienia i Zdjęcia', time: '21:00', durationMinutes: 30, notes: 'Pokaz zdjęć solenizanta i gości', linkedItemId: 'item_memories_slideshow' },
          { id: 'ag_4', title: 'Gorące Krzesło', time: '21:30', durationMinutes: 60, notes: 'Pytania i wyzwania od gości', linkedItemId: 'item_hot_seat_game' },
          { id: 'ag_5', title: 'Wielki Toast o Północy', time: '23:55', durationMinutes: 15, notes: 'Odliczanie do północy i życzenia', linkedItemId: 'item_midnight_toast' },
        ],
